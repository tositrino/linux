/* linux/drivers/media/video/dohofpga1.h
 *
...
#define DOHOFPGA1_COMPLETE
#undef DOHOFPGA1_COMPLETE

#ifndef __DOHOFPGA1_H__
#define __DOHOFPGA1_H__


#define DOHOFPGA1_DRIVER_NAME  "DOHOFPGA1"
//define __DOHOFPGA1_REGWRITE__

struct dohofpga1_reg 
{
  unsigned short addr;
  unsigned short val;
};

struct dohofpga1_regset_type 
{
 ...
 * Macro
 */
#define REGSET_LENGTH(x)  (sizeof(x)/sizeof(dohofpga1_reg))

/*
 * Host S/W Register interface (0x70000000-0x70002000)
 */
/* Initialization section */
#define DOHOFPGA1_Speed_368Mbps    0
#define DOHOFPGA1_Speed_464Mbps    1
#define DOHOFPGA1_Speed_552Mbps    2
#define DOHOFPGA1_Speed_648Mbps    3
#define DOHOFPGA1_Speed_736Mbps    4
#define DOHOFPGA1_Speed_832Mbps    5
#define DOHOFPGA1_Speed_920Mbps    6

#define DOHOFPGA14Khz_0Mhz    0x0000
#define DOHOFPGA14Khz_46Mhz    0x2CEC
#define DOHOFPGA14Khz_58Mhz    0x38A4
#define DOHOFPGA14Khz_69Mhz    0x4362
#define DOHOFPGA14Khz_81Mhz    0x4F1A
#define DOHOFPGA14Khz_91Mhz    0x58DE
#define DOHOFPGA14Khz_92Mhz    0x59D8
#define DOHOFPGA14Khz_93Mhz    0x5AD2
#define DOHOFPGA14Khz_104Mhz    0x6590
#define DOHOFPGA14Khz_115Mhz    0x704E

#define DOHOFPGA1FrTime_30fps    0x014D  /*  33.3ms -> 30 fps */
#define DOHOFPGA1FrTime_15fps    0x029A  /*  66.6ms -> 15 fps */
#define DOHOFPGA1FrTime_7P5fps    0x0535  /*  133.3ms -> 7.5 fps */
#define DOHOFPGA1FrTime_1P5fps    0x1964  /*  650.0ms -> 1.5 fps */
/*=====================================*/
/*========Register map for DOHOFPGA1 EVT1(Don't modify)===========*/
#define DOHOFPGA1_REG_TC_IPRM_InClockLSBs        0x0238
#define DOHOFPGA1_REG_TC_IPRM_InClockMSBs        0x023A
#define DOHOFPGA1_REG_TC_IPRM_UseNPviClocks      0x0252
#define DOHOFPGA1_REG_TC_IPRM_UseNMipiClocks      0x0254
#define DOHOFPGA1_REG_TC_IPRM_NumberOfMipiLanes      0x0256
#define DOHOFPGA1_REG_TC_IPRM_OpClk4KHz_0        0x025A
#define DOHOFPGA1_REG_TC_IPRM_MinOutRate4KHz_0      0x025C
#define DOHOFPGA1_REG_TC_IPRM_MaxOutRate4KHz_0      0x025E
#define DOHOFPGA1_REG_TC_IPRM_InitParamsUpdated      0x026E
#define DOHOFPGA1_REG_TC_GP_EnablePreview        0x0280
#define DOHOFPGA1_REG_TC_GP_EnablePreviewChanged      0x0282
#define DOHOFPGA1_REG_TC_GP_NewConfigSync        0x0290
#define DOHOFPGA1_REG_TC_GP_ActivePrevConfig      0x02A4
#define DOHOFPGA1_REG_TC_GP_PrevConfigChanged      0x02A6
#define DOHOFPGA1_REG_TC_GP_PrevOpenAfterChange      0x02A8
#define DOHOFPGA1_REG_0TC_PCFG_usWidth        0x02E2
#define DOHOFPGA1_REG_0TC_PCFG_usHeight        0x02E4
#define DOHOFPGA1_REG_0TC_PCFG_Format        0x02E6
#define DOHOFPGA1_REG_0TC_PCFG_usMaxOut4KHzRate      0x02E8
#define DOHOFPGA1_REG_0TC_PCFG_usMinOut4KHzRate      0x02EA
#define DOHOFPGA1_REG_0TC_PCFG_PVIMask        0x02F0
#define DOHOFPGA1_REG_0TC_PCFG_uClockInd        0x02F8
#define DOHOFPGA1_REG_0TC_PCFG_FrRateQualityType      0x02FC
#define DOHOFPGA1_REG_0TC_PCFG_usFrTimeType      0x02FA
#define DOHOFPGA1_REG_0TC_PCFG_usMaxFrTimeMsecMult10    0x02FE
#define DOHOFPGA1_REG_0TC_PCFG_usMinFrTimeMsecMult10    0x0300

#define DOHOFPGA1_PCLK_MIN  DOHOFPGA14Khz_115Mhz
#define DOHOFPGA1_PCLK_MAX  DOHOFPGA14Khz_115Mhz

#define DOHOFPGA1_FrTime_MAX  DOHOFPGA1FrTime_30fps
/*
 ...
 * in user aspect and must be match with index of dohofpga1_regset[]
 * These values indicates each controls and should be used
 * to control each control
 */
enum dohofpga1_control 
{
  DOHOFPGA1_INIT,
  DOHOFPGA1_EV,
  DOHOFPGA1_AWB,
  ...
  DOHOFPGA1_EFFECT,
  DOHOFPGA1_CONTRAST,
  DOHOFPGA1_SATURATION,
  DOHOFPGA1_SHARPNESS,
};

#define DOHOFPGA1_REGSET(x)  {  \
  .regset = x,      \
  .len = sizeof(x)/sizeof(dohofpga1_reg),}

/*
 * User tuned register setting values
 */
unsigned short dohofpga1_init0[]={
//mclk : 24MHz
...
//  for(k = 0; k < DOHOFPGA1_WAIT_TIMES; k ++)
...
#define DOHOFPGA1_INIT0  \
  (sizeof(dohofpga1_init0) / sizeof(dohofpga1_init0[0]))
#define DOHOFPGA1_Viewfinder_ON  \
  (sizeof(Viewfinder_ON) / sizeof(Viewfinder_ON[0]))
#define DOHOFPGA1_Viewfinder_OFF  \
  (sizeof(Viewfinder_OFF) / sizeof(Viewfinder_OFF[0]))

#define DOHOFPGA1_Refresh  \
  (sizeof(Refresh) / sizeof(Refresh[0]))
  
#define DOHOFPGA1_set_resol  \
  (sizeof(set_resol_640x480) / sizeof(set_resol_640x480[0]))

unsigned char dohofpga1_init_reg1[][4] = {
  {0xFC, 0xFC, 0xD0, 0x00},
...
unsigned short dohofpga1_init_reg2[][2] = {
  /* clk Settings */
  {0x002A, DOHOFPGA1_REG_TC_IPRM_InClockLSBs}, /* input=24MHz */
  {0x0F12, 0xBB80}, /*  input=48MHz : source clk is mpll */
  {0x002A, DOHOFPGA1_REG_TC_IPRM_InClockMSBs},
  {0x0F12, 0x0000},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_UseNPviClocks}, /* 0 PVI configurations */
  {0x0F12, 0x0000},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_UseNMipiClocks}, /* 1 MIPI configurations */
  {0x0F12, 0x0001},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_NumberOfMipiLanes}, /*  Num of lane MIPI  */
  {0x0F12, 2},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_OpClk4KHz_0}, /*  1st system CLK 92MHz
            * for parallel */
  {0x0F12, DOHOFPGA14Khz_92Mhz}, /*  2CEC */
  {0x002A, DOHOFPGA1_REG_TC_IPRM_MinOutRate4KHz_0},  /* Pclk : 92Mhz */
  {0x0F12, DOHOFPGA1_PCLK_MIN},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_MaxOutRate4KHz_0},
  {0x0F12, DOHOFPGA1_PCLK_MAX},
  {0x002A, DOHOFPGA1_REG_TC_IPRM_InitParamsUpdated},
  {0x0F12, 0x0001},
  {REG_DELAY, 100}, /*  p100 */
};

unsigned char dohofpga1_init_reg3[][4] = {
  /* AE Setting */
  {0x00, 0x2A, 0x13, 0xC8},
...
unsigned short dohofpga1_init_reg4[][2] = {
  /* / */
  /* PREVIEW CONFIGURATION 0 (FullHD, YUV, 20fps) */
  {0x002A, DOHOFPGA1_REG_0TC_PCFG_usWidth},
  {0x0F12, 1920},  /* 1920 */
  {0x0F12, 1080}, /* 1080 */
  {0x002A, 0x02E6},
};

unsigned char dohofpga1_init_reg5[][4] = {
...
unsigned char dohofpga1_init_jpeg[][4] = {
...
unsigned short dohofpga1_init_reg6[][2] = {
  {0x0F12, DOHOFPGA1_PCLK_MAX},
};

unsigned char dohofpga1_init_reg7[][4] = {
  {0x00, 0x2A, 0x02, 0xEA}, /* PCLK min */
};

unsigned short dohofpga1_init_reg8[][2] = {
  {0x0F12, DOHOFPGA1_PCLK_MIN},
};

unsigned char dohofpga1_init_reg9[][4] = {
...
unsigned short dohofpga1_init_reg10[][2] = {
  {0x002A, DOHOFPGA1_REG_0TC_PCFG_usMaxFrTimeMsecMult10},/* max frame time */
  {0x0F12, DOHOFPGA1_FrTime_MAX}, /* 30fps */
};

unsigned char dohofpga1_init_reg11[][4] = {
  /*  */
  /* PREVIEW */
  {0x00, 0x2A, 0x02, 0xA4},
  {0x0F, 0x12, 0x00, 0x00},
...
#define DOHOFPGA1_INIT_REGS1  \
  (sizeof(dohofpga1_init_reg1) / sizeof(dohofpga1_init_reg1[0]))
#define DOHOFPGA1_INIT_REGS2  \
  (sizeof(dohofpga1_init_reg2) / sizeof(dohofpga1_init_reg2[0]))
#define DOHOFPGA1_INIT_REGS3  \
  (sizeof(dohofpga1_init_reg3) / sizeof(dohofpga1_init_reg3[0]))
#define DOHOFPGA1_INIT_REGS4  \
  (sizeof(dohofpga1_init_reg4) / sizeof(dohofpga1_init_reg4[0]))
#define DOHOFPGA1_INIT_JPEG  \
  (sizeof(dohofpga1_init_jpeg) / sizeof(dohofpga1_init_jpeg[0]))
#define DOHOFPGA1_INIT_REGS5\
  (sizeof(dohofpga1_init_reg5) / sizeof(dohofpga1_init_reg5[0]))
#define DOHOFPGA1_INIT_REGS6  \
  (sizeof(dohofpga1_init_reg6) / sizeof(dohofpga1_init_reg6[0]))
#define DOHOFPGA1_INIT_REGS7  \
  (sizeof(dohofpga1_init_reg7) / sizeof(dohofpga1_init_reg7[0]))
#define DOHOFPGA1_INIT_REGS8  \
  (sizeof(dohofpga1_init_reg8) / sizeof(dohofpga1_init_reg8[0]))
#define DOHOFPGA1_INIT_REGS9  \
  (sizeof(dohofpga1_init_reg9) / sizeof(dohofpga1_init_reg9[0]))
#define DOHOFPGA1_INIT_REGS10  \
  (sizeof(dohofpga1_init_reg10) / sizeof(dohofpga1_init_reg10[0]))
#define DOHOFPGA1_INIT_REGS11  \
  (sizeof(dohofpga1_init_reg11) / sizeof(dohofpga1_init_reg11[0]))

unsigned short dohofpga1_sleep_reg[][2] = {
  {0x002A, DOHOFPGA1_REG_TC_GP_EnablePreview},
  {0x0F12, 0x0000},
  {0x002A, DOHOFPGA1_REG_TC_GP_EnablePreviewChanged},
  {0x0F12, 0x0001},
  {REG_DELAY, 100},
};

#define DOHOFPGA1_SLEEP_REGS  \
  (sizeof(dohofpga1_sleep_reg) / sizeof(dohofpga1_sleep_reg[0]))

unsigned short dohofpga1_wakeup_reg[][2] = {
  {0x002A, 0x02F0},
  {0x0F12, 0x0052},
  {0x002A, DOHOFPGA1_REG_TC_GP_PrevConfigChanged},
  {0x0F12, 0x0001},
};

#define DOHOFPGA1_WAKEUP_REGS  \
  (sizeof(dohofpga1_wakeup_reg) / sizeof(dohofpga1_wakeup_reg[0]))
...
static const struct dohofpga1_reg dohofpga1_ev_m6[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_m5[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_m4[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_m3[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_m2[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_m1[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_default[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p1[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p2[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p3[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p4[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p5[] = {
};

static const struct dohofpga1_reg dohofpga1_ev_p6[] = {
};

#ifdef DOHOFPGA1_COMPLETE
/* Order of this array should be following the querymenu data */
static const unsigned char *dohofpga1_regs_ev_bias[] = {
  (unsigned char *)dohofpga1_ev_m6, (unsigned char *)dohofpga1_ev_m5,
  (unsigned char *)dohofpga1_ev_m4, (unsigned char *)dohofpga1_ev_m3,
  (unsigned char *)dohofpga1_ev_m2, (unsigned char *)dohofpga1_ev_m1,
  (unsigned char *)dohofpga1_ev_default, (unsigned char *)dohofpga1_ev_p1,
  (unsigned char *)dohofpga1_ev_p2, (unsigned char *)dohofpga1_ev_p3,
  (unsigned char *)dohofpga1_ev_p4, (unsigned char *)dohofpga1_ev_p5,
  (unsigned char *)dohofpga1_ev_p6,
};

/*
 * Auto White Balance configure
 */
static const struct dohofpga1_reg dohofpga1_awb_off[] = {
};

static const struct dohofpga1_reg dohofpga1_awb_on[] = {
};

static const unsigned char *dohofpga1_regs_awb_enable[] = {
  (unsigned char *)dohofpga1_awb_off,
  (unsigned char *)dohofpga1_awb_on,
};

/*
 * Manual White Balance (presets)
 */
static const struct dohofpga1_reg dohofpga1_wb_tungsten[] = {

};

static const struct dohofpga1_reg dohofpga1_wb_fluorescent[] = {

};

static const struct dohofpga1_reg dohofpga1_wb_sunny[] = {

};

static const struct dohofpga1_reg dohofpga1_wb_cloudy[] = {

};

/* Order of this array should be following the querymenu data */
static const unsigned char *dohofpga1_regs_wb_preset[] = {
  (unsigned char *)dohofpga1_wb_tungsten,
  (unsigned char *)dohofpga1_wb_fluorescent,
  (unsigned char *)dohofpga1_wb_sunny,
  (unsigned char *)dohofpga1_wb_cloudy,
};

/*
 * Color Effect (COLORFX)
 */
static const struct dohofpga1_reg dohofpga1_color_sepia[] = {
};

static const struct dohofpga1_reg dohofpga1_color_aqua[] = {
};

static const struct dohofpga1_reg dohofpga1_color_monochrome[] = {
};

static const struct dohofpga1_reg dohofpga1_color_negative[] = {
};

static const struct dohofpga1_reg dohofpga1_color_sketch[] = {
};

/* Order of this array should be following the querymenu data */
static const unsigned char *dohofpga1_regs_color_effect[] = {
  (unsigned char *)dohofpga1_color_sepia,
  (unsigned char *)dohofpga1_color_aqua,
  (unsigned char *)dohofpga1_color_monochrome,
  (unsigned char *)dohofpga1_color_negative,
  (unsigned char *)dohofpga1_color_sketch,
};

/*
 * Contrast bias
 */
static const struct dohofpga1_reg dohofpga1_contrast_m2[] = {
};

static const struct dohofpga1_reg dohofpga1_contrast_m1[] = {
};

static const struct dohofpga1_reg dohofpga1_contrast_default[] = {
};

static const struct dohofpga1_reg dohofpga1_contrast_p1[] = {
};

static const struct dohofpga1_reg dohofpga1_contrast_p2[] = {
};

static const unsigned char *dohofpga1_regs_contrast_bias[] = {
  (unsigned char *)dohofpga1_contrast_m2,
  (unsigned char *)dohofpga1_contrast_m1,
  (unsigned char *)dohofpga1_contrast_default,
  (unsigned char *)dohofpga1_contrast_p1,
  (unsigned char *)dohofpga1_contrast_p2,
};

/*
 * Saturation bias
 */
static const struct dohofpga1_reg dohofpga1_saturation_m2[] = {
};

static const struct dohofpga1_reg dohofpga1_saturation_m1[] = {
};

static const struct dohofpga1_reg dohofpga1_saturation_default[] = {
};

static const struct dohofpga1_reg dohofpga1_saturation_p1[] = {
};

static const struct dohofpga1_reg dohofpga1_saturation_p2[] = {
};

static const unsigned char *dohofpga1_regs_saturation_bias[] = {
  (unsigned char *)dohofpga1_saturation_m2,
  (unsigned char *)dohofpga1_saturation_m1,
  (unsigned char *)dohofpga1_saturation_default,
  (unsigned char *)dohofpga1_saturation_p1,
  (unsigned char *)dohofpga1_saturation_p2,
};

/*
 * Sharpness bias
 */
static const struct dohofpga1_reg dohofpga1_sharpness_m2[] = {
};

static const struct dohofpga1_reg dohofpga1_sharpness_m1[] = {
};

static const struct dohofpga1_reg dohofpga1_sharpness_default[] = {
};

static const struct dohofpga1_reg dohofpga1_sharpness_p1[] = {
};

static const struct dohofpga1_reg dohofpga1_sharpness_p2[] = {
};

static const unsigned char *dohofpga1_regs_sharpness_bias[] = {
  (unsigned char *)dohofpga1_sharpness_m2,
  (unsigned char *)dohofpga1_sharpness_m1,
  (unsigned char *)dohofpga1_sharpness_default,
  (unsigned char *)dohofpga1_sharpness_p1,
  (unsigned char *)dohofpga1_sharpness_p2,
};
#endif /* DOHOFPGA1 _COMPLETE */

#ifdef __DOHOFPGA1_C__

static inline struct dohofpga1_state *to_state(struct v4l2_subdev *) ;
static inline int dohofpga1_write(struct v4l2_subdev *, u16 , u16 ) ;
static int dohofpga1_i2c_write(struct v4l2_subdev *, unsigned char[], unsigned char);
const  char * const *dohofpga1_ctrl_get_menu( u32 ) ;
static inline struct v4l2_queryctrl const *dohofpga1_find_qctrl(int ) ;
static int dohofpga1_queryctrl(struct v4l2_subdev *, struct v4l2_queryctrl *) ;
static int dohofpga1_querymenu(struct v4l2_subdev *, struct v4l2_querymenu *) ;
static int dohofpga1_s_crystal_freq(struct v4l2_subdev *, u32  , u32 ) ;
static int dohofpga1_g_fmt(struct v4l2_subdev *, struct v4l2_mbus_framefmt *) ;
static int dohofpga1_s_fmt(struct v4l2_subdev *, struct v4l2_mbus_framefmt *) ;
static int dohofpga1_enum_framesizes(struct v4l2_subdev *,struct v4l2_frmsizeenum *) ;
static int dohofpga1_enum_frameintervals(struct v4l2_subdev *,struct v4l2_frmivalenum *);
static int dohofpga1_g_parm(struct v4l2_subdev *, struct v4l2_streamparm *);
static int dohofpga1_s_parm(struct v4l2_subdev *, struct v4l2_streamparm *);
static int dohofpga1_g_ctrl(struct v4l2_subdev *, struct v4l2_control *);
static int dohofpga1_s_ctrl(struct v4l2_subdev *, struct v4l2_control *);
static int __dohofpga1_init_2byte(struct v4l2_subdev *, unsigned short[], int );
static int dohofpga1_init(struct v4l2_subdev *, u32);
static int dohofpga1_s_power(struct v4l2_subdev *, int );
static int dohofpga1_sleep(struct v4l2_subdev *);
static int dohofpga1_wakeup(struct v4l2_subdev *);
static int dohofpga1_s_stream(struct v4l2_subdev *, int);
static int dohofpga1_probe(struct i2c_client *, const struct i2c_device_id *);
static int dohofpga1_remove(struct i2c_client *);
...
struct dohofpga1_state 
{
  struct dohofpga1_mbus_platform_data *pdata;
  struct v4l2_subdev sd;
  struct v4l2_mbus_framefmt   fmt;
  struct v4l2_fract     timeperframe;
  struct dohofpga1_userset     userset;
...
static const char *dohofpga1_querymenu_wb_preset[] = 
{
  "WB Tungsten", "WB Fluorescent", "WB sunny", "WB cloudy", NULL
};

static const char *dohofpga1_querymenu_effect_mode[] = 
{
  "Effect Sepia", "Effect Aqua", "Effect Monochrome",
  "Effect Negative", "Effect Sketch", NULL
};

static const char *dohofpga1_querymenu_ev_bias_mode[] = 
{
...
static struct v4l2_queryctrl dohofpga1_controls[] = 
{
  {
    /*
  ...
  },
  {
    ...
    .minimum = 0,
    .maximum = ARRAY_SIZE(dohofpga1_querymenu_wb_preset) - 2,
    .step = 1,
    .default_value = 0,
  },
  {
  ...
  },
  {
    ...
    .name = "Exposure bias",
    .minimum = 0,
    .maximum = ARRAY_SIZE(dohofpga1_querymenu_ev_bias_mode) - 2,
    .step = 1,
    .default_value = (ARRAY_SIZE(dohofpga1_querymenu_ev_bias_mode) \
        - 2) / 2,  /* 0 EV */
  },
  {
    .id = V4L2_CID_COLORFX,
    ...
    .name = "Image Effect",
    .minimum = 0,
    .maximum = ARRAY_SIZE(dohofpga1_querymenu_effect_mode) - 2,
    .step = 1,
    .default_value = 0,
  },
  {
...
static const struct v4l2_subdev_core_ops dohofpga1_core_ops =
{
  .init = dohofpga1_init,  /* initializing API */
  .s_power = dohofpga1_s_power,
  .queryctrl = dohofpga1_queryctrl,
  .querymenu = dohofpga1_querymenu,
  .g_ctrl = dohofpga1_g_ctrl,
  .s_ctrl = dohofpga1_s_ctrl,
};

static const struct v4l2_subdev_video_ops dohofpga1_video_ops = 
{
  .s_crystal_freq = dohofpga1_s_crystal_freq,
  .g_mbus_fmt = dohofpga1_g_fmt,
  .s_mbus_fmt = dohofpga1_s_fmt,
  .enum_framesizes = dohofpga1_enum_framesizes,
  .enum_frameintervals = dohofpga1_enum_frameintervals,
  .g_parm = dohofpga1_g_parm,
  .s_parm = dohofpga1_s_parm,
  .s_stream = dohofpga1_s_stream,
};

static const struct v4l2_subdev_ops dohofpga1_ops = 
{
  .core = &dohofpga1_core_ops,
  .video = &dohofpga1_video_ops,
};

static const struct i2c_device_id dohofpga1_id[] = 
{
  { DOHOFPGA1_DRIVER_NAME, 0 },
  { },
};

MODULE_DEVICE_TABLE(i2c, dohofpga1_id);

static struct i2c_driver dohofpga1_i2c_driver = 
{
  .driver = 
  {
    .name  = DOHOFPGA1_DRIVER_NAME,
  },
  .probe    = dohofpga1_probe,
  .remove    = dohofpga1_remove,
  .id_table  = dohofpga1_id,
};
